...
import com.example.bluetoothdemo.adapter.BlueListAdapter;
import com.example.bluetoothdemo.enity.BlueDevice;
import com.example.bluetoothdemo.util.BluetoothUtil;
import com.example.bluetoothdemo.util.PermissionUtil;
...
public class MainActivity extends AppCompatActivity  implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            ck_bluetooth.setChecked(true); // 已经打开蓝牙
        }
