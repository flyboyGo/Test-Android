package com.example.traditionbluetoothdemo;
...
import com.example.traditionbluetoothdemo.adapter.BlueListAdapter;
import com.example.traditionbluetoothdemo.enity.BlueDevice;
import com.example.traditionbluetoothdemo.task.BlueAcceptTask;
import com.example.traditionbluetoothdemo.task.BlueConnectTask;
import com.example.traditionbluetoothdemo.task.BlueReceiveTask;
import com.example.traditionbluetoothdemo.util.BluetoothUtil;
import com.example.traditionbluetoothdemo.util.PermissionUtil;
...
public class BluetoothTransActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ck_bluetooth.setOnCheckedChangeListener(this); // 蓝牙打开按钮的监听，弹出是否允许扫描蓝牙设备的选择对话框
    ...
    private void initBlueDevice()
    {
        ...
        // 首次打开页面，则创建一个新的蓝牙设备列表(ListView)的适配器
