package com.example.traditionalbluetoothdemo_client.task;
...
import com.example.traditionalbluetoothdemo_client.util.BluetoothConnector;
        ...
        try {
            ...
            if(socket != null)
            {
                mAct.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mListener.onBlueConnect(socket);
                    }
                });
            }
        } catch (Exception e) {
