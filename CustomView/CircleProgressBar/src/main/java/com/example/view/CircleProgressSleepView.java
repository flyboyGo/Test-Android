...
public class CircleProgressSleepView extends View {
    ...
    public CircleProgressSleepView(Context context) {
        this(context,null);
    }

    public CircleProgressSleepView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CircleProgressSleepView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr,0);
    }

    public CircleProgressSleepView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
